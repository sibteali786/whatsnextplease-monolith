...
export const NotificationResponseArraySchema = z.array(
...
export const NotificationMarkAsReadParams = z.object({
  id: z
    ...
    .regex(
      uuidv4Pattern,
      "Invalid notification ID format - must be a valid UUID",
    )
    .transform((val) => val.toLowerCase()),
});
export type NotificationMarkAsReadParams = z.infer<
  typeof NotificationMarkAsReadParams
>;
...
export type NotificationMarkAsReadResponse = z.infer<
  typeof NotificationMarkAsReadResponseSchema
>;
